    ...
    <div class="middle-content">
      ...
      <el-table
        ...
        <el-table-column
          ...
          width="200">
          <template slot-scope="scope">
            <el-button @click.native.prevent="" type="warning" size="mini">禁用</el-button>
            <el-button @click.native.prevent="" type="primary" size="mini">修改</el-button>
            <el-button @click.native.prevent="" type="danger" size="mini">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="operation-area">
        <div class="fl btn-area">
          <el-button type="success" size="small" @click="">添加应用</el-button>
        </div>
        <el-pagination
          class="fr page-area"
